...
function Ornament() {
  return (
    ...
    >
      <path
        d="M0 14 Q20 4 40 14 Q60 24 80 14 Q100 4 120 14 Q140 24 160 14 Q170 9 180 14"
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
            <a
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background = "var(--color-blue-bright)";
        ...
        >
          ...
          {/* Main holographic shape */}
          <div
            className="holo-shape"
            style={{
              width: 360,
              height: 360,
              position: "relative",
